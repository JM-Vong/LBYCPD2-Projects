package sample;
//Original Author: cyberpirate92
// Github link: https://github.com/cyberpirate92/Halstead-Metrics
...
class HalsteadComplexity
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            BufferedReader reader = new BufferedReader(new FileReader(new File("C:\\Users\\Job\\IdeaProjects\\LBYCP2D\\src\\sample\\Controller.java")));
            String line;
